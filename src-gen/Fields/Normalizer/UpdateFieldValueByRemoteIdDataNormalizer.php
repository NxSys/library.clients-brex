...
class UpdateFieldValueByRemoteIdDataNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \NxSys\Library\Clients\Brex\API\Fields\Model\UpdateFieldValueByRemoteIdData::class;
    }
    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \NxSys\Library\Clients\Brex\API\Fields\Model\UpdateFieldValueByRemoteIdData::class;
    }
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        $object = new \NxSys\Library\Clients\Brex\API\Fields\Model\UpdateFieldValueByRemoteIdData();
    ...
    {
        return [\NxSys\Library\Clients\Brex\API\Fields\Model\UpdateFieldValueByRemoteIdData::class => false];
    }
}