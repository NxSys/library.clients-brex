...
class RailBookingDataNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \NxSys\Library\Clients\Brex\API\Travel\Model\RailBookingData::class;
    }
    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \NxSys\Library\Clients\Brex\API\Travel\Model\RailBookingData::class;
    }
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        if (\array_key_exists('journeys', $data)) {
            ...
            foreach ($data['journeys'] as $value) {
                $values[] = $this->denormalizer->denormalize($value, \NxSys\Library\Clients\Brex\API\Travel\Model\RailBookingDataRailJourney::class, 'json', $context);
            }
    ...
    {
        return [\NxSys\Library\Clients\Brex\API\Travel\Model\RailBookingData::class => false];
    }
}