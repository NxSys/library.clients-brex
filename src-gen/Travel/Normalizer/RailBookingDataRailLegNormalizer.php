...
class RailBookingDataRailLegNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'NxSys\\Library\\Clients\\Brex\\API\\Travel\\Model\\RailBookingDataRailLeg';
    }

    public function supportsNormalization($data, $format = null): bool
    {
        return is_object($data) && get_class($data) === 'NxSys\\Library\\Clients\\Brex\\API\\Travel\\Model\\RailBookingDataRailLeg';
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        if (\array_key_exists('origin', $data)) {
            $object->setOrigin($this->denormalizer->denormalize($data['origin'], 'NxSys\\Library\\Clients\\Brex\\API\\Travel\\Model\\RailBookingDataRailStation', 'json', $context));
            unset($data['origin']);
        }
        if (\array_key_exists('destination', $data)) {
            $object->setDestination($this->denormalizer->denormalize($data['destination'], 'NxSys\\Library\\Clients\\Brex\\API\\Travel\\Model\\RailBookingDataRailStation', 'json', $context));
            unset($data['destination']);
        }
        if (\array_key_exists('departure_time', $data)) {
            $object->setDepartureTime($this->denormalizer->denormalize($data['departure_time'], 'NxSys\\Library\\Clients\\Brex\\API\\Travel\\Model\\RailBookingDataRailLegDepartureTime', 'json', $context));
            unset($data['departure_time']);
        }
        if (\array_key_exists('arrival_time', $data)) {
            $object->setArrivalTime($this->denormalizer->denormalize($data['arrival_time'], 'NxSys\\Library\\Clients\\Brex\\API\\Travel\\Model\\RailBookingDataRailLegArrivalTime', 'json', $context));
        ...
        if (\array_key_exists('vehicle', $data)) {
            $object->setVehicle($this->denormalizer->denormalize($data['vehicle'], 'NxSys\\Library\\Clients\\Brex\\API\\Travel\\Model\\RailBookingDataRailLegVehicle', 'json', $context));
            unset($data['vehicle']);
        }
        if (\array_key_exists('seat', $data)) {
            $object->setSeat($this->denormalizer->denormalize($data['seat'], 'NxSys\\Library\\Clients\\Brex\\API\\Travel\\Model\\RailBookingDataRailLegSeat', 'json', $context));
            unset($data['seat']);
        }
