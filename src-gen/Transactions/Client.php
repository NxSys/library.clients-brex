...
class Client extends \NxSys\Library\Clients\Brex\API\Transactions\Runtime\Client\Client
{
     ...
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     *
     * @return \NxSys\Library\Clients\Brex\API\Transactions\Model\PageStatement|\Psr\Http\Message\ResponseInterface|null
     *
     ...
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     *
     * @return \NxSys\Library\Clients\Brex\API\Transactions\Model\PageCashAccount|\Psr\Http\Message\ResponseInterface|null
     *
     ...
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     *
     * @return \NxSys\Library\Clients\Brex\API\Transactions\Model\CashAccount|\Psr\Http\Message\ResponseInterface|null
     *
     ...
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     *
     * @return \NxSys\Library\Clients\Brex\API\Transactions\Model\PageCardTransaction|\Psr\Http\Message\ResponseInterface|null
     *
     ...
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     *
     * @return \NxSys\Library\Clients\Brex\API\Transactions\Model\PageCashTransaction|\Psr\Http\Message\ResponseInterface|null
     *
