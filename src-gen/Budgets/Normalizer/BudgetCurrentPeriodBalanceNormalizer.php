...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class BudgetCurrentPeriodBalanceNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === \NxSys\Library\Clients\Brex\API\Budgets\Model\BudgetCurrentPeriodBalance::class;
        }

        public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
        {
            return is_object($data) && get_class($data) === \NxSys\Library\Clients\Brex\API\Budgets\Model\BudgetCurrentPeriodBalance::class;
        }
        ...
        public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
        {
            ...
            if (\array_key_exists('balance', $data)) {
                $object->setBalance($this->denormalizer->denormalize($data['balance'], \NxSys\Library\Clients\Brex\API\Budgets\Model\BudgetPeriodBalanceBalance::class, 'json', $context));
                unset($data['balance']);
            }
        ...
        {
            return [\NxSys\Library\Clients\Brex\API\Budgets\Model\BudgetCurrentPeriodBalance::class => false];
        }
    }
} else {
    class BudgetCurrentPeriodBalanceNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
