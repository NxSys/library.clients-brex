...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class UpdateBudgetRequestNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === \NxSys\Library\Clients\Brex\API\Budgets\Model\UpdateBudgetRequest::class;
        }

        public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
        {
            return is_object($data) && get_class($data) === \NxSys\Library\Clients\Brex\API\Budgets\Model\UpdateBudgetRequest::class;
        }
        ...
        public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
        {
            ...
            if (\array_key_exists('limit', $data)) {
                $object->setLimit($this->denormalizer->denormalize($data['limit'], \NxSys\Library\Clients\Brex\API\Budgets\Model\UpdateBudgetRequestLimit::class, 'json', $context));
                unset($data['limit']);
            }
        ...
        {
            return [\NxSys\Library\Clients\Brex\API\Budgets\Model\UpdateBudgetRequest::class => false];
        }
    }
} else {
    class UpdateBudgetRequestNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
