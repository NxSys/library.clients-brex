...
class BudgetNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'NxSys\\Library\\Clients\\Brex\\API\\Budgets\\Model\\Budget';
    }

    public function supportsNormalization($data, $format = null): bool
    {
        return is_object($data) && get_class($data) === 'NxSys\\Library\\Clients\\Brex\\API\\Budgets\\Model\\Budget';
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        if (\array_key_exists('limit', $data)) {
            $object->setLimit($this->denormalizer->denormalize($data['limit'], 'NxSys\\Library\\Clients\\Brex\\API\\Budgets\\Model\\BudgetLimit', 'json', $context));
            unset($data['limit']);
        }
        ...
        if (\array_key_exists('current_period_balance', $data)) {
            $object->setCurrentPeriodBalance($this->denormalizer->denormalize($data['current_period_balance'], 'NxSys\\Library\\Clients\\Brex\\API\\Budgets\\Model\\BudgetCurrentPeriodBalance', 'json', $context));
