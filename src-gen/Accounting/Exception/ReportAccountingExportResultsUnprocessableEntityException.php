...
class ReportAccountingExportResultsUnprocessableEntityException extends UnprocessableEntityException
{
    /**
    ...
    {
        parent::__construct('Validation failed (duplicate accounting record ids or records not READY_FOR_EXPORT)');
