...
class CreateIntegrationConflictException extends ConflictException
{
    /**
    ...
    {
        parent::__construct('Active integration exists with different vendor or different vendor account ID');
