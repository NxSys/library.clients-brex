...
class ExpandableExpenseNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'NxSys\\Library\\Clients\\Brex\\API\\Expenses\\Model\\ExpandableExpense';
    }

    public function supportsNormalization($data, $format = null): bool
    {
        return is_object($data) && get_class($data) === 'NxSys\\Library\\Clients\\Brex\\API\\Expenses\\Model\\ExpandableExpense';
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        if (\array_key_exists('location', $data)) {
            $object->setLocation($this->denormalizer->denormalize($data['location'], 'NxSys\\Library\\Clients\\Brex\\API\\Expenses\\Model\\ExpandableExpenseLocation', 'json', $context));
            unset($data['location']);
        }
        ...
        if (\array_key_exists('department', $data)) {
            $object->setDepartment($this->denormalizer->denormalize($data['department'], 'NxSys\\Library\\Clients\\Brex\\API\\Expenses\\Model\\ExpandableExpenseDepartment', 'json', $context));
        ...
        if (\array_key_exists('receipts', $data) && $data['receipts'] !== null) {
            ...
            foreach ($data['receipts'] as $value) {
                $values[] = $this->denormalizer->denormalize($value, 'NxSys\\Library\\Clients\\Brex\\API\\Expenses\\Model\\Receipt', 'json', $context);
            }
