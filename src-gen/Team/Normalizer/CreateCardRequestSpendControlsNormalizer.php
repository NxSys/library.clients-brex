...
class CreateCardRequestSpendControlsNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \NxSys\Library\Clients\Brex\API\Team\Model\CreateCardRequestSpendControls::class;
    }
    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \NxSys\Library\Clients\Brex\API\Team\Model\CreateCardRequestSpendControls::class;
    }
    ...
    {
        return [\NxSys\Library\Clients\Brex\API\Team\Model\CreateCardRequestSpendControls::class => false];
    }
}