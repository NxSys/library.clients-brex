...
class UpdateCardRequestSpendControlsNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'NxSys\\Library\\Clients\\Brex\\API\\Team\\Model\\UpdateCardRequestSpendControls';
    }

    public function supportsNormalization($data, $format = null): bool
    {
        return is_object($data) && get_class($data) === 'NxSys\\Library\\Clients\\Brex\\API\\Team\\Model\\UpdateCardRequestSpendControls';
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        if (\array_key_exists('spend_limit', $data)) {
            $object->setSpendLimit($this->denormalizer->denormalize($data['spend_limit'], 'NxSys\\Library\\Clients\\Brex\\API\\Team\\Model\\SpendControlUpdateRequestSpendLimit', 'json', $context));
