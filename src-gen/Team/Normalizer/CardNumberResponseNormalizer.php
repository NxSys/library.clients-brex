...
class CardNumberResponseNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \NxSys\Library\Clients\Brex\API\Team\Model\CardNumberResponse::class;
    }
    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \NxSys\Library\Clients\Brex\API\Team\Model\CardNumberResponse::class;
    }
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        if (\array_key_exists('expiration_date', $data)) {
            $object->setExpirationDate($this->denormalizer->denormalize($data['expiration_date'], \NxSys\Library\Clients\Brex\API\Team\Model\CardExpiration::class, 'json', $context));
    ...
    public function normalize(mixed $data, ?string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
    {
        ...
        $dataArray['cvv'] = $data->getCvv();
        $dataArray['expiration_date'] = $this->normalizer->normalize($data->getExpirationDate(), 'json', $context);
        foreach ($data as $key => $value) {
            if (preg_match('/.*/', (string) $key)) {
                $dataArray[$key] = $value;
            }
    ...
    {
        return [\NxSys\Library\Clients\Brex\API\Team\Model\CardNumberResponse::class => false];
    }
}