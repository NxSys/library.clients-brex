...
class CardNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'NxSys\\Library\\Clients\\Brex\\API\\Team\\Model\\Card';
    }

    public function supportsNormalization($data, $format = null): bool
    {
        return is_object($data) && get_class($data) === 'NxSys\\Library\\Clients\\Brex\\API\\Team\\Model\\Card';
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        if (\array_key_exists('spend_controls', $data)) {
            $object->setSpendControls($this->denormalizer->denormalize($data['spend_controls'], 'NxSys\\Library\\Clients\\Brex\\API\\Team\\Model\\CardSpendControls', 'json', $context));
            unset($data['spend_controls']);
        }
        if (\array_key_exists('billing_address', $data)) {
            $object->setBillingAddress($this->denormalizer->denormalize($data['billing_address'], 'NxSys\\Library\\Clients\\Brex\\API\\Team\\Model\\Address', 'json', $context));
            unset($data['billing_address']);
        }
        if (\array_key_exists('mailing_address', $data)) {
            $object->setMailingAddress($this->denormalizer->denormalize($data['mailing_address'], 'NxSys\\Library\\Clients\\Brex\\API\\Team\\Model\\CardMailingAddress', 'json', $context));
