...
class CardSpendControlsNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'NxSys\\Library\\Clients\\Brex\\API\\Team\\Model\\CardSpendControls';
    }

    public function supportsNormalization($data, $format = null): bool
    {
        return is_object($data) && get_class($data) === 'NxSys\\Library\\Clients\\Brex\\API\\Team\\Model\\CardSpendControls';
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        if (\array_key_exists('spend_available', $data)) {
            $object->setSpendAvailable($this->denormalizer->denormalize($data['spend_available'], 'NxSys\\Library\\Clients\\Brex\\API\\Team\\Model\\Money', 'json', $context));
