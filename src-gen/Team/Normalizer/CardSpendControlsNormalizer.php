...
class CardSpendControlsNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \NxSys\Library\Clients\Brex\API\Team\Model\CardSpendControls::class;
    }
    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \NxSys\Library\Clients\Brex\API\Team\Model\CardSpendControls::class;
    }
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        $object = new \NxSys\Library\Clients\Brex\API\Team\Model\CardSpendControls();
        ...
        if (\array_key_exists('spend_available', $data)) {
            $object->setSpendAvailable($this->denormalizer->denormalize($data['spend_available'], \NxSys\Library\Clients\Brex\API\Team\Model\Money::class, 'json', $context));
            unset($data['spend_available']);
        }
    ...
    public function normalize(mixed $data, ?string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
    {
        ...
        $dataArray['spend_available'] = $this->normalizer->normalize($data->getSpendAvailable(), 'json', $context);
    ...
    {
        return [\NxSys\Library\Clients\Brex\API\Team\Model\CardSpendControls::class => false];
    }
}