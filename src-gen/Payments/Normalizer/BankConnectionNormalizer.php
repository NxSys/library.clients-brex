...
class BankConnectionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'NxSys\\Library\\Clients\\Brex\\API\\Payments\\Model\\BankConnection';
    }

    public function supportsNormalization($data, $format = null): bool
    {
        return is_object($data) && get_class($data) === 'NxSys\\Library\\Clients\\Brex\\API\\Payments\\Model\\BankConnection';
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        if (\array_key_exists('bank_details', $data)) {
            $object->setBankDetails($this->denormalizer->denormalize($data['bank_details'], 'NxSys\\Library\\Clients\\Brex\\API\\Payments\\Model\\BankDetails', 'json', $context));
        ...
        if (\array_key_exists('available_balance', $data)) {
            $object->setAvailableBalance($this->denormalizer->denormalize($data['available_balance'], 'NxSys\\Library\\Clients\\Brex\\API\\Payments\\Model\\BankConnectionAvailableBalance', 'json', $context));
            unset($data['available_balance']);
        }
        if (\array_key_exists('current_balance', $data)) {
            $object->setCurrentBalance($this->denormalizer->denormalize($data['current_balance'], 'NxSys\\Library\\Clients\\Brex\\API\\Payments\\Model\\BankConnectionCurrentBalance', 'json', $context));
