...
class VendorResponseNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \NxSys\Library\Clients\Brex\API\Payments\Model\VendorResponse::class;
    }
    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \NxSys\Library\Clients\Brex\API\Payments\Model\VendorResponse::class;
    }
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        if (\array_key_exists('payment_accounts', $data) && $data['payment_accounts'] !== null) {
            ...
            foreach ($data['payment_accounts'] as $value) {
                $values[] = $this->denormalizer->denormalize($value, \NxSys\Library\Clients\Brex\API\Payments\Model\PaymentAccountResponse::class, 'json', $context);
            }
    ...
    {
        return [\NxSys\Library\Clients\Brex\API\Payments\Model\VendorResponse::class => false];
    }
}