...
class CreateVendorRequestNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'NxSys\\Library\\Clients\\Brex\\API\\Payments\\Model\\CreateVendorRequest';
    }

    public function supportsNormalization($data, $format = null): bool
    {
        return is_object($data) && get_class($data) === 'NxSys\\Library\\Clients\\Brex\\API\\Payments\\Model\\CreateVendorRequest';
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        if (\array_key_exists('payment_accounts', $data) && $data['payment_accounts'] !== null) {
            ...
            foreach ($data['payment_accounts'] as $value) {
                $values[] = $this->denormalizer->denormalize($value, 'NxSys\\Library\\Clients\\Brex\\API\\Payments\\Model\\PaymentAccountRequest', 'json', $context);
            }
